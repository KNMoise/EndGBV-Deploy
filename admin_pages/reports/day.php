...
<html>
<head>
	<title> Today's Report For <?php echo date("l"); ?></title>
		...
		<div class="header">
			<div class="logo_invoice_wrap">
				...
				<div class="invoice_sec">
					<p class="invoice bold">TODAY'S REPORT</p>
					<p class="invoice_no">
		...
		<div class="body">
			<div class="main_table">
				...
				<div class="table_body">
					<?php
						...
						$sql = "SELECT DISTINCT  j.job_id, j.job_title, SUM(e.amount) AS total_expenses, j.income, j.job_date FROM incomes j LEFT JOIN expenses e ON j.job_id = e.job_linked WHERE date(j.job_date) = CURDATE() GROUP BY j.job_id;";
			...
			<div class="paymethod_grandtotal_wrap" style="margin: auto;">
				...
				<div class="grandtotal_sec">
					<?php 
						$query = "SELECT SUM(income) as total_earnings FROM incomes  WHERE date(job_date) = CURDATE();";
			    	...
			    	<?php 
						$query = "SELECT SUM(amount) as total_expense FROM expenses WHERE date(expense_date) = CURDATE();;";
						$query2 = mysqli_query($conn, $query);
