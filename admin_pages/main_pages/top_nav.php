        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <div class="sidebar-brand-icon rotate-n-15"><img src="assets/img/Artboard%2019.png"
                            style="height: 44px;width: 44;"></div>
                </a>
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                <div class="nav-item dropdown no-arrow">
                                    <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown"
                                        href="#"><span class="badge bg-danger badge-counter">
                                            <?php
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        <h6 class="dropdown-header" style="background: rgb(14,69,58)">E-mails Received 
                                        </h6>
                                        <?php
                                        ...
                                        while ($rows = mysqli_fetch_assoc($query2)) {
                                            ...
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="view_email.php?id=<?php echo $id; ?>">
                                                <div class="fw-bold">
